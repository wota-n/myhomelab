...
admin=192.168.1.150
master1=192.168.1.151
master2=192.168.1.152
#master3=192.168.3.23
worker1=192.168.1.153
...
# Array of all
all=($master1 $master2 $worker1)

# Array of all minus master1
allnomaster1=($master2 $worker1)

#Loadbalancer IP range
lbrange=192.168.1.160-192.168.1.180
